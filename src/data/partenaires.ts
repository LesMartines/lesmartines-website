...
export interface Partenaire {
  ...
  logo: string
  description?: string
  // Catégorie(s) affichées en discret sur la carte (05/09/2026, "pour qu'on comprenne
  // direct ce que c'est [...] discret et premium" puis "on peut avoir les marques qui ont
  // deux catégories") : classification maison, pas de donnée source équivalente sur
  // lesmartines.app/nos-partenaires. 1 ou 2 entrées : une marque à cheval sur 2 univers
  // (ex. lingerie menstruelle) peut porter les 2 plutôt qu'être forcée dans une seule case.
  category?: string[]
}
